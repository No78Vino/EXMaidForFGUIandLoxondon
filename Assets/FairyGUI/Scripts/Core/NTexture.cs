...
namespace FairyGUI
{
    ...
    public class NTexture
    {
        ...
        /// <summary>
        /// </summary>
        public bool disposed => root == null;

        /// <summary>
        /// </summary>
        public Texture nativeTexture => root != null ? root._nativeTexture : null;

        /// <summary>
        /// </summary>
        public Texture alphaTexture => root != null ? root._alphaTexture : null;
        ...
        public MaterialManager GetMaterialManager(string shaderName)
        {
            if (root != this)
            {
                if (root == null)
                    return null;
                return root.GetMaterialManager(shaderName);
            }
