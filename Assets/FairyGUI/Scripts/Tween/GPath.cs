...
namespace FairyGUI
{
    ...
    public class GPath
    {
        private static readonly List<GPathPoint> helperList = new();
        private static readonly List<Vector3> splinePoints = new();
        ...
        public Vector3 GetPointAt(float t)
        {
            ...
            if (t == 1)
            {
                ...
                if (seg.type == GPathPoint.CurveType.Bezier || seg.type == GPathPoint.CurveType.CubicBezier)
