...
namespace FairyGUI
{
    ...
    public class GTextField : GObject, ITextColorGear
    {
        ...
        public Color color
        {
            get => _textField.textFormat.color;
            set
            {
