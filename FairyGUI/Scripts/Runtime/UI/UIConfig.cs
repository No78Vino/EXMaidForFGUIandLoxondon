...
namespace FairyGUI
{
    ...
    public class UIConfig : MonoBehaviour
    {
        ...
        /// </summary>
        public static Color modalLayerColor = new(0f, 0f, 0f, 0.4f);
        ...
        /// <summary>
        ///     When the scrolling container is set to "snap to the item", the rolling distance threshold of which item is close to
        ///     is determined.
        /// </summary>
        public static float defaultScrollSnappingThreshold = 0.5f;

        /// <summary>
        ///     When the scrolling container is set to "page mode", it determines the scrolling distance threshold to which page to
        ///     turn.
        /// </summary>
        ...
        public List<ConfigValue> Items = new();
        public List<string> PreloadPackages = new();
