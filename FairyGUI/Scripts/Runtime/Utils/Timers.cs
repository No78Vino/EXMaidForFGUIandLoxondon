...
namespace FairyGUI
{
    ...
    public class Timers
    {
        ...
        private readonly TimersEngine _engine;

        private readonly Dictionary<TimerCallback, Anymous_T> _items;
        private readonly List<Anymous_T> _pool;
        private readonly Dictionary<TimerCallback, Anymous_T> _toAdd;
        private readonly List<Anymous_T> _toRemove;
